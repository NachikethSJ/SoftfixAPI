...
///  Store Membership  
membershipController.storeMembership = async function (req, res) 
{
...
///  Update Membership  
membershipController.updateMembership = async function (req, res) 
{
...
///  IsDelete Membership  
membershipController.isDeleteMembership = async function (req, res) 
{
...
//Delete Membership
membershipController.deleteMembership = function (req, res) 
{
...
//Fatch Membership
membershipController.viewMembership = function (req, res) 
{
...
membershipController.viewMembershipdropdown = function (req, res) 
{
...
membershipController.viewMembershipService = function (req, res) 
{
    db.query("select d.id, r.servicename,s.type,s.price,d.offer,s.timetaken,s.details,s.persontype,s.termandcondition,s.file from servicetype s  JOIN membership_details  d ON s.id = d.serviceTypeId join service r on r.id=s.serviceId where  d.IsDelete='0' and  d.membershipid='"+req.body.membershipId+"'", (err, result, fields) =>{
        if (err) throw err;
        config.response(200, 'Membership Data Fetched Successfully !', result, res);
    });
...
membershipController.storeMembershipDetails = async function (req, res) 
{
...
membershipController.updateMembershipDetails = async function (req, res) 
{
...
membershipController.updateMembershipDetailsStatus = async function (req, res) 
{
...
membershipController.deleteMembershipDetails = function (req, res) 
{
...
membershipController.viewMembershipDetails = function (req, res) 
{
